...
// InitConfigDir finds the configuration directory for microNeo according to the XDG spec.
...
func InitConfigDir(flagConfigDir string) error {
	...
	ConfigDir = filepath.Join(xdgHome, "microNeo")
	...
	// Create microNeo config directory if it does not exist
