...
> 状态：✅ 已发 2 篇（第一篇 6/20 晚发、第二篇 6/23 早发）
...
|---|---|---|---|---|---|---|---|---|
| **#1 实际** | 把一个 line editor 改造成 render editor | ✅ 已发 (2026-06-20 晚) | — | — | [知乎](https://zhuanlan.zhihu.com/p/2051803011857528091) | — | **78 views (6/23，3 天累计)** | 实际主题超出 §6 提议 5 篇；**3 天 ≈26/天，验证表与行：候是加码** |
| **#2 实际** | 表格渲染器 table-render | ✅ 已发 (2026-06-23) | — | — | [知乎](https://zhuanlan.zhihu.com/p/2052800304651964980) | — | 待观察 | 实际主题超出 §6 提议 5 篇（table render 主题未在清单；列宽算法伏笔留 #3） |
